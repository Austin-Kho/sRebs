...
class AccountSubD2(models.Model):
    d1 = models.ForeignKey(AccountSubD1, on_delete=models.CASCADE)
    code = models.CharField(max_length=3)
...
class AccountSubD3(models.Model):
    d2 = models.ForeignKey(AccountSubD2, on_delete=models.CASCADE)
    code = models.CharField(max_length=3)
    name = models.CharField(max_length=20)
...
class ProjectAccountD2(models.Model):
    d1 = models.ForeignKey(ProjectAccountD1, on_delete=models.CASCADE)
    code = models.CharField(max_length=3)
