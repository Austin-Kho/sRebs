...
from rebs_project.models import UnitType
...
class ContractorReleaseForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'status': forms.HiddenInput(), 'register': forms.HiddenInput()
        }
...
class ContractPaymentForm(forms.ModelForm):
    ...
    def __init__(self, project, *args, **kwargs):
        ...
        self.fields['installment_order'].queryset = InstallmentPaymentOrder.objects.filter(project=project, pay_code__lte='4')
